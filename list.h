...
/* terminal pid - kill all terminal to standard output */
void terminal_kill(list_pid *list);

/* terminar kil abruta - kill all terminal to standard output */
void terminal_kill_abruta();
/* remove pid of list _pid */
void remover_pid(list_pid *list, char  *pid);
